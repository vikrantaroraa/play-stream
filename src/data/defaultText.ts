...
⚙️ Usage
Open Play Stream in your web browser.
Upload a .txt file or manually input text into the text area.
Press Play to start reading, Pause to pause, Resume to continue, or Stop to end the reading.
Select a preferred voice from the dropdown menu.
Adjust the reading speed using the slider (0.5x to 2x speed).
Watch as Play Stream highlights the current spoken word and the entire sentence in real-time.
Adjust the voice or speed anytime during playback. The app will maintain sync with the current spoken word and sentence.
